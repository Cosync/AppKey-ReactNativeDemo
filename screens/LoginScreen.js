...
const LoginScreen = props => {
  ...
  async function socialSignupHandler(token, provider, handle, firstName, lastName, locale) {
    try {
      
      let result = await socialSignup(token, provider, handle, firstName, lastName, locale);
